...
public class RevVoiceInput{
    ...
    public func startRecognition(currentViewController viewController: UIViewController,voiceInputDelegates:VoiceInputDelegates,isUIRequired:Bool) {
        if(self.lang=="")
        {
    ...
    public func startRecognition(on viewController: UIViewController,voiceInputDelegates:VoiceInputDelegates,isUIRequired:Bool,domain:String,lang:String) {
    ...
    {
        voiceSearchWithoutUi?.stopStreamingForFinal()
    }
    
    ///  This function is stop the voice and kill the voice search without Result
    public func cancel()
    {
        voiceSearchWithoutUi?.stopStreaming()
